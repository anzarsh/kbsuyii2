...
class SearchEvent extends Model
{
	...
	public function rules()
	{
	    return [
	        ...
	        [['uname', 'level', 'coordinator', 'startdate', 'finishdate', 'id_activity0','id_activity1','id_activity2','id_activity3','id_eventtype0','id_eventtype1','id_eventtype2','id_eventtype3','id_eventtype4','id_eventtype5','id_eventtype6','id_eventtype7','id_eventtype8'], 'required', 'when' => function () {
